...
chmod +x "$DEL_RES_DIR/del_res_qmmm_cp2k.sh" "$DEL_RES_DIR/mol2_vmd-qmsel.sh" "$MUT_SCAN_DIR/mut_scan_qmmm_cp2k.sh" "$MUT_SCAN_DIR/sp_mutation.sh" "$MUT_SCAN_DIR/mut_qm_sel.sh" "$MUT_MULTI_DIR/mut_mp_qmmm_cp2k.sh"  "$MUT_MULTI_DIR/mp_mutation.sh"  "$MUT_MULTI_DIR/mut_qm_sel.sh"
